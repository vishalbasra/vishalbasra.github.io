...
- Now the **HOSTS.TXT** file was maintained by [SRI](https://www.sri.com/)-NIC ( you may also want to see [Timeline on SRI](https://www.sri.com/work/timeline-innovation/timeline.php?timeline=computing-digital#!&innovation=domain-names-network-information-center) and [SRI's Role in managing NIC](https://www.sri.com/about/timeline/tld-nic)
